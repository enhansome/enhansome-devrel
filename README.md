...
* [github.com/jpetazzo/container.training](https://github.com/jpetazzo/container.training) ⭐ 3,947 | 🐛 24 | 🌐 Shell | 📅 2026-09-09: This repository contains materials (slides, scripts, demo app, and other code samples) used for various workshops, tutorials, and training sessions around the themes of Docker, containers, and orchestration.
...
* [gitbook.com](https://github.com/GitbookIO/gitbook) ⭐ 29,028 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-15: Modern documentation format and toolchain using Git and Markdown
...
* [Developers Conferences Agenda/list](https://github.com/scraly/developers-conferences-agenda/) ⭐ 2,002 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-15 - A list of worldwide conferences since 2017 with date and location
...
* [crowd.dev](https://crowd.dev): Find high-intent accounts in your developer data ([GitHub repo](https://github.com/CrowdDotDev/crowd.dev) ⭐ 3,368 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-15)
