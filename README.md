...
* [gitbook.com](https://github.com/GitbookIO/gitbook) ⭐ 29,017 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-28: Modern documentation format and toolchain using Git and Markdown
...
* [terminalizer](https://github.com/faressoft/terminalizer) ⭐ 16,158 | 🐛 108 | 🌐 JavaScript | 📅 2024-08-29: Record terminal sessions and save to GIF.
* [Peek](https://github.com/phw/peek) ⚠️ Archived (for Linux): Capture screen area and save as GIF or video formats.
* [gifsicle](https://github.com/kohler/gifsicle) ⭐ 4,309 | 🐛 28 | 🌐 C | 📅 2026-01-31: Optimize and edit GIFs for sharing.
...
* [Developers Conferences Agenda/list](https://github.com/scraly/developers-conferences-agenda/) ⭐ 2,000 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-28 - A list of worldwide conferences since 2017 with date and location
...
* [vmbrasseur/Public\_Speaking](https://github.com/vmbrasseur/Public_Speaking) ⭐ 1,453 | 🐛 25 | 📅 2024-08-11: A big open source list of conference speaking tips.
...
* [crowd.dev](https://crowd.dev): Find high-intent accounts in your developer data ([GitHub repo](https://github.com/CrowdDotDev/crowd.dev) ⭐ 3,365 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-28)
